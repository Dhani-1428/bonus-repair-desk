...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "subscription.freePlan": "Free Plan - 15 Days",
    "subscription.freeTrialMessage": "You're currently on a 15-day FREE trial. Your trial will end on",
  ...
  pt: {
    ...
    "subscription.freePlan": "Plano Gratuito - 15 Dias",
    "subscription.freeTrialMessage": "Está atualmente num período de teste GRATUITO de 15 dias. O seu período de teste termina em",
