...
export function NewReleasePromo() {
  return (
    <section className="mt-12 w-full">
      <div className="mx-auto max-w-4xl rounded-[40px] border border-gray-800/50 p-2 shadow-xl">
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-gray-800/50 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-600 p-2 shadow-2xl">
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              ...
              <div className="flex items-center justify-center">
                <Link href="/register">
                  <div className="group border border-gray-800/50 bg-gradient-to-r from-gray-900/70 to-black/70 backdrop-blur-sm flex h-[64px] cursor-pointer items-center gap-2 rounded-full p-[11px] mt-10 shadow-xl hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300">
                    <div className="border border-gray-700/50 bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-sm flex h-[43px] items-center justify-center rounded-full hover:from-white/30 hover:to-white/20 transition-all duration-300 group-hover:scale-105">
                    ...
                    <div className="border border-gray-700/50 flex size-[26px] items-center justify-center rounded-full transition-all ease-in-out group-hover:ml-2 group-hover:border-blue-400/50">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                        height="18"
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="lucide lucide-arrow-right text-gray-300 group-hover:text-white transition-all ease-in-out group-hover:rotate-45"
                        aria-hidden="true"
                      >
