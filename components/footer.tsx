      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-foreground text-background font-bold text-lg">
                B
              </div>
              <span className="font-bold text-xl">Bonus Repair Desk</span>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Professional repair shop management system. Streamline your operations and grow your business.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-border/40 text-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Bonus Repair Desk. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
